...
from src.widget import info_cart, transformation_date
...
def test_info_cart():
    assert info_cart("MasterCard 7158300734726758") == "MasterCard 7158 30** **** 6758"
    assert info_cart("") == " Не верно введен номер карты"


def test_trans_date():
    assert transformation_date("2018-07-11T02:26:18.671407") == "11.07.2018"
    assert transformation_date("") == "Введена не корректная дата"
